...
class User implements UserInterface
{
    ...
    public function setRepeatPlainPassword($plainPassword): self
    {
    ...
    {
        return $this->restore_password;
    }

    public function setRestorePassword($string): self
    {
        $this->restore_password = $string;
