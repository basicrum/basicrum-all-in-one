...
class UserAgentImportTest extends NoFixturesTestCase
{
    /**
     ...
     * @group import
     */
    public function testUserAgentSimpleImport()
    {
        $reader = $this
