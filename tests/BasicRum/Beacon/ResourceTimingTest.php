...
class ResourceTimingTest extends NoFixturesTestCase
{
     ...
     * @group import
     */
    public function testResourceTimingsFkOffset()
    {
        $reader = $this
        ...
        $manager = $this->_getDoctrine()->getRepository(\App\Entity\ResourceTimings::class);

        $qb = $manager->createQueryBuilder('rt');
        $result = $qb
            ->select('rt.pageViewId')
            ->getQuery()
            ->getArrayResult();
